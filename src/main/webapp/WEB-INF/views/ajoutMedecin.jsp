...
<div class="box">
	...
	<div class="box-body">
		<form method="post" action="addMedecin">
			<div class="box-body">
				...
				<div class="form-group">
					<label>Numero télephone : </label> <input type="text"
						class="form-control" pattern="[0-9]{8}" title="8 chiffres"
						name="numerotel" required="true">
				</div>
				<div class="form-group">
